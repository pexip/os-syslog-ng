...
/* "%code top" blocks.  */
#line 23 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:316  */

#include "add-contextual-data-parser.h"


#line 68 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:316  */

/* Substitute the variable and function names.  */
#define yyparse         add_contextual_data_parse
#define yylex           add_contextual_data_lex
#define yyerror         add_contextual_data_error
#define yydebug         add_contextual_data_debug
#define yynerrs         add_contextual_data_nerrs


/* Copy the first part of user declarations.  */

#line 80 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_ADD_CONTEXTUAL_DATA_MODULES_ADD_CONTEXTUAL_DATA_ADD_CONTEXTUAL_DATA_GRAMMAR_H_INCLUDED
# define YY_ADD_CONTEXTUAL_DATA_MODULES_ADD_CONTEXTUAL_DATA_ADD_CONTEXTUAL_DATA_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_ON_ERROR = 10510,
    KW_RETRIES = 10511,
    KW_ADD_CONTEXTUAL_DATA = 10513,
    KW_ADD_CONTEXTUAL_DATA_DATABASE = 10514,
    KW_ADD_CONTEXTUAL_DATA_SELECTOR = 10515,
    KW_ADD_CONTEXTUAL_DATA_DEFAULT_SELECTOR = 10516,
    KW_ADD_CONTEXTUAL_DATA_PREFIX = 10517
  };
#endif
/* Tokens.  */
...
#define KW_ADD_CONTEXTUAL_DATA 10513
#define KW_ADD_CONTEXTUAL_DATA_DATABASE 10514
#define KW_ADD_CONTEXTUAL_DATA_SELECTOR 10515
#define KW_ADD_CONTEXTUAL_DATA_DEFAULT_SELECTOR 10516
#define KW_ADD_CONTEXTUAL_DATA_PREFIX 10517
...
int add_contextual_data_parse (CfgLexer *lexer, LogParser **instance, gpointer arg);

#endif /* !YY_ADD_CONTEXTUAL_DATA_MODULES_ADD_CONTEXTUAL_DATA_ADD_CONTEXTUAL_DATA_GRAMMAR_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 421 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 29 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:359  */
...
#line 57 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:359  */
...
#line 494 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:359  */
...
{
       0,   366,   366,   372,   371,   382,   383,   387,   391,   395,
     399,   626,   627
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_ADD_CONTEXTUAL_DATA", "KW_ADD_CONTEXTUAL_DATA_DATABASE",
  "KW_ADD_CONTEXTUAL_DATA_SELECTOR",
  "KW_ADD_CONTEXTUAL_DATA_DEFAULT_SELECTOR",
  "KW_ADD_CONTEXTUAL_DATA_PREFIX", "'('", "')'", "'{'", "'}'", "';'",
  "':'", "$accept", "start", "parser_expr_add_contextual_data", "$@1",
  "parser_add_contextual_data_opts", "parser_add_contextual_data_opt",
  "string", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10516, 10517,    40,    41,   123,   125,    59,    58
};
# endif
...
{
      -1,  -131,    11,  -130,  -139,  -139,  -139,  -138,  -129,  -128,
    -127,  -126,  -125,  -138,  -113,  -113,  -113,  -113,  -139,  -139,
    -139,  -139,  -124,  -123,  -122,  -121,  -139,  -139,  -139,  -139
};
...
{
       8,     9,    10,    11,    20,     1,     3,    21,    23,    24,
      25,     5,     6,    14,    15,    16,    17,    19,    18,    26,
      27,    28,    29
};

static const yytype_uint8 yycheck[] =
{
     138,   139,   140,   141,   117,     6,   137,   120,    15,    16,
      17,     0,   142,   142,   142,   142,   142,    13,   143,   143,
     143,   143,   143
};
...
{
       0,     6,   149,   137,   150,     0,   142,   151,   138,   139,
     140,   141,   152,   153,   142,   142,   142,   142,   143,   152,
     117,   120,   154,   154,   154,   154,   143,   143,   143,   143
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,   148,   149,   151,   150,   152,   152,   153,   153,   153,
     153,   154,   154
};
...
#line 291 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2477 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;

    case 120: /* LL_STRING  */
#line 291 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2483 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;

    case 122: /* LL_BLOCK  */
#line 291 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2489 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;

    case 154: /* string  */
#line 291 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2495 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 366 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2789 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 372 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            last_parser = *instance = add_contextual_data_parser_new(configuration);
          }
#line 2797 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 377 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2803 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 388 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_filename(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
        }
#line 2812 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 392 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_database_selector_template(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
        }
#line 2821 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 396 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_database_default_selector(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
        }
#line 2830 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 400 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_prefix(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
        }
#line 2839 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;


#line 2843 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 945 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1906  */
