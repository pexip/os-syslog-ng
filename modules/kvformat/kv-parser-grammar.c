...
/* "%code top" blocks.  */
#line 22 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:316  */

#include "kv-parser-parser.h"


#line 68 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:316  */

/* Substitute the variable and function names.  */
#define yyparse         kv_parser_parse
#define yylex           kv_parser_lex
#define yyerror         kv_parser_error
#define yydebug         kv_parser_debug
#define yynerrs         kv_parser_nerrs


/* Copy the first part of user declarations.  */

#line 80 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_KV_PARSER_MODULES_KVFORMAT_KV_PARSER_GRAMMAR_H_INCLUDED
# define YY_KV_PARSER_MODULES_KVFORMAT_KV_PARSER_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_RETRIES = 10511,
    KW_KV_PARSER = 10513,
    KW_LINUX_AUDIT_PARSER = 10514,
    KW_PREFIX = 10515,
    KW_VALUE_SEPARATOR = 10516
  };
#endif
/* Tokens.  */
...
#define KW_KV_PARSER 10513
#define KW_LINUX_AUDIT_PARSER 10514
#define KW_PREFIX 10515
#define KW_VALUE_SEPARATOR 10516
...
#endif /* !YY_KV_PARSER_MODULES_KVFORMAT_KV_PARSER_GRAMMAR_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 419 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 28 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:359  */
...
#line 55 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:359  */
...
#line 491 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:359  */
...
{
       0,   363,   363,   369,   368,   375,   374,   383,   384,   388,
     389,   395,   619,   620,   678
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_KV_PARSER", "KW_LINUX_AUDIT_PARSER", "KW_PREFIX",
  "KW_VALUE_SEPARATOR", "'('", "')'", "'{'", "'}'", "';'", "':'",
  "$accept", "start", "parser_expr_kv", "$@1", "$@2", "parser_kv_opts",
  "parser_kv_opt", "string", "parser_opt", YY_NULLPTR
};
#endif
...
{
       3,  -134,    10,  -130,  -129,  -135,  -135,  -135,  -135,   -96,
     -96,  -128,  -127,  -126,  -125,   -96,  -135,  -124,  -115,  -115,
    -115,  -135,  -135,  -135,  -135,  -135,  -123,  -122,  -121,  -135,
    -135,  -135
};
...
{
    -135,  -135,  -135,  -135,  -135,    -9,  -135,   -12,  -135
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     5,     9,    10,    14,    15,    26,    16
};
...
{
      11,    17,    24,     3,     4,    25,    22,    27,    28,     1,
       6,     7,     8,    18,    19,    20,     0,    21,    23,    29,
...
{
      96,    10,   117,   137,   138,   120,    15,    19,    20,     6,
       0,   141,   141,   141,   141,   141,    -1,   142,   142,   142,
...
{
       0,     6,   148,   137,   138,   149,     0,   141,   141,   150,
     151,    96,   139,   140,   152,   153,   155,   152,   141,   141,
     141,   142,   152,   142,   117,   120,   154,   154,   154,   142,
     142,   142
};
...
{
       0,   147,   148,   150,   149,   151,   149,   152,   152,   153,
     153,   153,   154,   154,   155
};
...
#line 289 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2478 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 120: /* LL_STRING  */
#line 289 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2484 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 122: /* LL_BLOCK  */
#line 289 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2490 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 154: /* string  */
#line 289 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2496 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 363 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2790 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 369 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
	    last_parser = *instance = (LogParser *) kv_parser_new(configuration, kv_scanner_new());
	  }
#line 2798 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 373 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2804 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 5:
#line 375 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
	    last_parser = *instance = (LogParser *) kv_parser_new(configuration, linux_audit_scanner_new());
	  }
#line 2812 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 6:
#line 379 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2818 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 388 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { kv_parser_set_prefix(last_parser, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2824 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 390 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
	    CHECK_ERROR((strlen((yyvsp[-1].cptr)) == 1), (yylsp[-1]), "kv-parser() only supports single-character values for value-separator()");
            kv_parser_set_value_separator(last_parser, (yyvsp[-1].cptr)[0]);
            free((yyvsp[-1].cptr));
          }
#line 2834 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 14:
#line 678 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2848 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;


#line 2852 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 938 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1906  */
