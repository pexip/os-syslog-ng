...
{
     139,     0,    -1,     6,   140,    -1,    -1,   134,   135,   141,
     144,   136,    -1,   143,    -1,    30,   135,   148,   136,    -1,
      97,   135,   147,   136,    -1,   145,   144,    -1,    -1,   142,
      -1,    78,   135,   146,   136,    -1,    39,   135,   147,   136,
      -1,    40,   135,   147,   136,    -1,    41,   135,   147,   136,
      -1,    42,   135,   147,   136,    -1,   147,   146,    -1,    -1,
     119,    -1,   122,    -1,   149,    -1,   147,   149,    -1,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   311,   311,   317,   316,   325,   326,   330,   343,   344,
...
static const char *const yytname[] =
{
  ...
  "KW_SCOPE", "KW_CSV_PARSER", "'('", "')'", "':'", "$accept", "start",
  "parser_expr_csv", "$@1", "parser_column_opt", "parser_opt",
  "parser_csv_opts", "parser_csv_opt", "parser_csv_flags", "string",
  "string_list", "string_list_build", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10502, 10503, 10504, 10505, 10507,    40,    41,    58
};
# endif
...
{
       0,   138,   139,   141,   140,   142,   142,   143,   144,   144,
...
{
       1,  -126,    14,  -120,  -127,  -127,  -127,   -30,  -118,  -117,
    -115,  -114,  -113,  -112,  -111,  -127,  -127,  -110,   -30,  -106,
    -106,  -106,  -106,  -106,  -106,  -106,  -127,  -127,  -127,  -127,
    -106,  -109,  -127,  -108,  -107,  -105,  -104,  -103,  -106,  -102,
...
{
    -127,  -127,  -127,  -127,  -127,  -127,     7,  -127,    -8,   -19,
    -127,     5
};
...
static const yytype_uint8 yytable[] =
{
      ...
      21,    22,    23,    24,    25,    27,    26,    41,    42,    43,
      47,    44,    45,    46,    48,    40,     0,     0,     0,     0,
...
{
      30,    20,    21,    22,    23,    24,    25,     6,   134,    39,
      40,    41,    42,   119,     0,   135,   122,   135,   135,    38,
     135,   135,   135,   135,   135,    18,   136,   136,   136,   136,
      38,   136,   136,   136,   136,    30,    -1,    -1,    -1,    -1,
...
{
       0,     6,   139,   134,   140,     0,   135,   141,    30,    39,
      40,    41,    42,    78,    97,   142,   143,   144,   145,   135,
     135,   135,   135,   135,   135,   135,   136,   144,   119,   122,
     147,   148,   149,   147,   147,   147,   147,   146,   147,   147,
     149,   136,   136,   136,   136,   136,   136,   146,   136
};
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, CfgLexer *lexer, LogParser **instance, gpointer arg)
#else
static void
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (CfgLexer *lexer, LogParser **instance, gpointer arg);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
/* Line 1455 of yacc.c  */
#line 330 "csvparser-grammar.y"
    {
                                                  LogTemplate *template;
                                                  GError *error = NULL;

						  template = cfg_check_inline_template(configuration, (yyvsp[(3) - (4)].cptr), &error);
                                                  CHECK_ERROR(template != NULL, (yylsp[(3) - (4)]), "Error compiling template (%s)", error->message);
