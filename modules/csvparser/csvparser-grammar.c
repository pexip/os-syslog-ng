...
/* "%code top" blocks.  */
#line 24 "modules/csvparser/csvparser-grammar.y" /* yacc.c:316  */

#include "csvparser-parser.h"


#line 68 "modules/csvparser/csvparser-grammar.c" /* yacc.c:316  */
...
#line 80 "modules/csvparser/csvparser-grammar.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_CSVPARSER_MODULES_CSVPARSER_CSVPARSER_GRAMMAR_H_INCLUDED
# define YY_CSVPARSER_MODULES_CSVPARSER_CSVPARSER_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#define KW_CSV_PARSER 10513
#define KW_DIALECT 10514
#define KW_PREFIX 10515
#define KW_COLUMNS 10516
#define KW_DELIMITERS 10517
#define KW_QUOTES 10518
#define KW_QUOTE_PAIRS 10519
#define KW_NULL 10520
#define KW_CHARS 10521
#define KW_STRINGS 10522
...
#endif /* !YY_CSVPARSER_MODULES_CSVPARSER_CSVPARSER_GRAMMAR_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 431 "modules/csvparser/csvparser-grammar.c" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 30 "modules/csvparser/csvparser-grammar.y" /* yacc.c:359  */
...
#line 58 "modules/csvparser/csvparser-grammar.y" /* yacc.c:359  */
...
#line 504 "modules/csvparser/csvparser-grammar.c" /* yacc.c:359  */
...
{
       0,   374,   374,   380,   379,   389,   390,   395,   396,   398,
     399,   400,   401,   402,   403,   404,   408,   409,   413,   414,
     418,   419,   423,   430,   434,   661,   662,   683,   687,   688,
     720
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_CSV_PARSER", "KW_DIALECT", "KW_PREFIX", "KW_COLUMNS",
  "KW_DELIMITERS", "KW_QUOTES", "KW_QUOTE_PAIRS", "KW_NULL", "KW_CHARS",
  "KW_STRINGS", "'('", "')'", "'{'", "'}'", "';'", "':'", "$accept",
  "start", "parser_expr_csv", "$@1", "parser_csv_opts", "parser_csv_opt",
  "parser_csv_delimiters", "parser_csv_delimiters_opts",
  "parser_csv_delimiters_opt", "parser_csv_flags", "parser_csv_dialect",
  "string", "string_list", "string_list_build", "parser_opt", YY_NULLPTR
};
#endif
...
{
      -1,  -127,    12,  -126,  -129,  -129,  -129,   -77,  -125,  -124,
    -123,  -122,  -121,  -120,  -119,  -118,  -117,  -116,   -77,  -129,
    -106,  -106,  -106,  -106,  -106,  -104,  -106,  -106,  -106,  -129,
    -129,  -129,  -129,  -115,  -106,  -114,  -113,  -129,  -112,  -106,
    -111,  -129,  -109,  -107,  -105,  -129,  -128,  -129,  -103,  -102,
    -101,  -129,  -129,  -129,  -129,  -129,  -129,  -129,  -106,  -106,
    -129,  -129,  -129,  -129,  -129,  -100,   -99,  -129,  -129
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      23,     0,     0,     0,    29,    19,     0,     0,     0,     4,
       5,    25,    26,     0,    23,     0,     0,    24,     0,    29,
       0,    27,     0,     0,     0,    17,    19,    16,     0,     0,
       0,     7,    22,    30,     9,     8,    28,    14,     0,    29,
      10,    18,    11,    12,    13,     0,     0,    20,    21
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
    -129,  -129,  -129,  -129,     2,  -129,  -129,   -15,  -129,    10,
    -129,   -19,    -9,    13,  -129
};
...
{
       8,    34,    35,    37,    38,     1,    47,    48,    49,    50,
       3,    31,     5,    31,    32,    34,    32,    42,    43,     9,
      30,     6,    20,    21,    22,    23,    24,    25,    26,    27,
      28,    61,    29,    51,    53,    54,    55,    57,    58,    65,
      59,    42,    43,    60,    52,    62,    63,    64,    67,    68,
...
{
      77,    20,    21,    22,    23,     6,    25,    26,    27,    28,
     137,   117,     0,   117,   120,    34,   120,   145,   146,    96,
      18,   147,   147,   147,   147,   147,   147,   147,   147,   147,
     147,    46,   148,   148,   148,   148,   148,   148,   147,    58,
     147,   145,   146,   148,    34,   148,   148,   148,   148,   148,
      59,    -1,    39,    -1,    -1,    -1,    -1,    -1,    -1,    -1,
...
{
       0,     6,   154,   137,   155,     0,   147,   156,    77,    96,
     138,   139,   140,   141,   142,   143,   144,   157,   158,   167,
     147,   147,   147,   147,   147,   147,   147,   147,   147,   148,
     157,   117,   120,   162,   164,   164,   163,   164,   164,   164,
     165,   166,   145,   146,   159,   160,   161,   164,   164,   164,
     164,   148,   162,   148,   148,   148,   166,   148,   147,   147,
     148,   160,   148,   148,   148,   164,   165,   148,   148
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,   153,   154,   156,   155,   157,   157,   158,   158,   158,
...
#line 292 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2517 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1257  */
        break;

    case 120: /* LL_STRING  */
#line 292 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2523 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1257  */
        break;

    case 122: /* LL_BLOCK  */
#line 292 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2529 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1257  */
        break;

    case 164: /* string  */
#line 292 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2535 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 374 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2829 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 380 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    {
            last_parser = *instance = csv_parser_new(configuration);
          }
#line 2837 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 384 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2843 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 395 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { CHECK_ERROR(csv_parser_set_flags(last_parser, (yyvsp[-1].num)), (yylsp[-1]), "only one escape style can be used in the flags argument"); }
#line 2849 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 396 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_parser_set_prefix(last_parser, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2855 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 398 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_scanner_options_set_dialect(csv_parser_get_scanner_options(last_parser), (yyvsp[-1].num)); }
#line 2861 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 400 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_scanner_options_set_quotes(csv_parser_get_scanner_options(last_parser), (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2867 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 401 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_scanner_options_set_quote_pairs(csv_parser_get_scanner_options(last_parser), (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2873 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 13:
#line 402 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_scanner_options_set_null_value(csv_parser_get_scanner_options(last_parser), (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2879 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 14:
#line 403 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_scanner_options_set_columns(csv_parser_get_scanner_options(last_parser), (yyvsp[-1].ptr)); }
#line 2885 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 408 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    {  csv_scanner_options_set_delimiters(csv_parser_get_scanner_options(last_parser), (yyvsp[0].cptr)); free((yyvsp[0].cptr));  }
#line 2891 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 20:
#line 418 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_scanner_options_set_delimiters(csv_parser_get_scanner_options(last_parser), (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2897 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 21:
#line 419 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { csv_scanner_options_set_string_delimiters(csv_parser_get_scanner_options(last_parser), (yyvsp[-1].ptr)); }
#line 2903 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 22:
#line 424 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    {
            guint32 flag = csv_parser_lookup_flag((yyvsp[-1].cptr));
            CHECK_ERROR(flag != 0, (yylsp[-1]), "unknown csv-parser() flag %s", (yyvsp[-1].cptr));
            (yyval.num) = flag | (yyvsp[0].num);
            free((yyvsp[-1].cptr));
          }
#line 2914 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 23:
#line 430 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 0; }
#line 2920 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 24:
#line 434 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    {
                                                  gint mode = csv_parser_lookup_dialect((yyvsp[0].cptr));
                                                  CHECK_ERROR(mode >= 0, (yylsp[0]), "unknown dialect() argument for csv-parser()");
                                                  free((yyvsp[0].cptr));
                                                }
#line 2930 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 27:
#line 683 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = g_list_reverse((yyvsp[0].ptr)); }
#line 2936 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 28:
#line 687 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = g_list_append((yyvsp[0].ptr), g_strdup((yyvsp[-1].cptr))); free((yyvsp[-1].cptr)); }
#line 2942 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 29:
#line 688 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = NULL; }
#line 2948 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;

  case 30:
#line 720 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2962 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
    break;


#line 2966 "modules/csvparser/csvparser-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 980 "modules/csvparser/csvparser-grammar.y" /* yacc.c:1906  */
