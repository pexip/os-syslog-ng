...
{
     140,     0,    -1,     5,   141,    -1,   116,    -1,   135,   136,
     142,   137,    -1,   117,    -1,    -1,   146,   143,   144,    -1,
     145,   144,    -1,    -1,   116,    -1,   134,   136,   146,   137,
      -1,   117,    -1,   119,    -1,   122,    -1
};
...
{
       0,   312,   312,   317,   320,   321,   328,   327,   338,   339,
     343,   346,   347,   355,   356
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_SCOPE", "KW_DOOR", "KW_SUN_STREAMS", "'('", "')'", "':'", "$accept",
  "start", "source_afstreams", "source_afstreams_params", "$@1",
  "source_afstreams_options", "source_afstreams_option", "string", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10502, 10503, 10504, 10505, 10020, 10021,    40,    41,    58
};
# endif
...
{
       0,   139,   140,   141,   141,   141,   143,   142,   144,   144,
     145,   145,   145,   146,   146
};
...
{
       0,  -116,     6,  -129,  -129,  -128,  -129,  -129,  -115,  -129,
    -129,  -127,  -129,  -129,  -114,  -129,  -129,  -125,  -129,  -114,
    -115,  -129,  -124,  -129
};
...
static const yytype_uint8 yytable[] =
{
      ...
      13,    20,    22,    23,     0,     0,     0,     0,     0,     5,
      17
};

static const yytype_int16 yycheck[] =
{
     116,   117,   116,   117,   119,     5,     0,   122,   136,    19,
     137,   136,    20,   137,    -1,    -1,    -1,    -1,    -1,   135,
     134
};
...
{
       0,     5,   140,   116,   117,   135,   141,     0,   136,   119,
     122,   142,   146,   137,   143,   116,   117,   134,   144,   145,
     136,   144,   146,   137
};
...
#line 328 "afstreams-grammar.y"
    {
#if ENABLE_SUN_STREAMS
	    last_driver = *instance = afstreams_sd_new((yyvsp[(1) - (1)].cptr));
	    free((yyvsp[(1) - (1)].cptr));
#endif
	  }
    break;
