...
#define yyparse         python_parse
#define yylex           python_lex
#define yyerror         python_error
#define yydebug         python_debug
#define yynerrs         python_nerrs


/* Copy the first part of user declarations.  */

#line 73 "modules/python/python-grammar.c" /* yacc.c:339  */
...
#define KW_PYTHON 10513
#define KW_CLASS 10514
#define KW_IMPORTS 10515
