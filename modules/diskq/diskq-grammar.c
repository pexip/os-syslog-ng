...
/* "%code top" blocks.  */
#line 25 "modules/diskq/diskq-grammar.y" /* yacc.c:316  */

#include "diskq-parser.h"


#line 68 "modules/diskq/diskq-grammar.c" /* yacc.c:316  */

/* Substitute the variable and function names.  */
#define yyparse         diskq_parse
#define yylex           diskq_lex
#define yyerror         diskq_error
#define yydebug         diskq_debug
#define yynerrs         diskq_nerrs


/* Copy the first part of user declarations.  */

#line 80 "modules/diskq/diskq-grammar.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_DISKQ_MODULES_DISKQ_DISKQ_GRAMMAR_H_INCLUDED
# define YY_DISKQ_MODULES_DISKQ_DISKQ_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_ON_ERROR = 10510,
    KW_RETRIES = 10511,
    KW_DISK_BUFFER = 10513,
    KW_MEM_BUF_LENGTH = 10514,
    KW_DISK_BUF_SIZE = 10515,
    KW_RELIABLE = 10516,
    KW_MEM_BUF_SIZE = 10517,
    KW_QOUT_SIZE = 10518,
    KW_DIR = 10519
  };
#endif
...
#define KW_DISK_BUFFER 10513
#define KW_MEM_BUF_LENGTH 10514
#define KW_DISK_BUF_SIZE 10515
#define KW_RELIABLE 10516
#define KW_MEM_BUF_SIZE 10517
#define KW_QOUT_SIZE 10518
#define KW_DIR 10519
...
#endif /* !YY_DISKQ_MODULES_DISKQ_DISKQ_GRAMMAR_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 425 "modules/diskq/diskq-grammar.c" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 31 "modules/diskq/diskq-grammar.y" /* yacc.c:359  */
...
#line 64 "modules/diskq/diskq-grammar.y" /* yacc.c:359  */
...
#line 503 "modules/diskq/diskq-grammar.c" /* yacc.c:359  */
...
{
       0,   374,   374,   379,   378,   388,   389,   393,   394,   395,
     396,   397,   398,   622,   623,   627,   628,   629
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_DISK_BUFFER", "KW_MEM_BUF_LENGTH", "KW_DISK_BUF_SIZE", "KW_RELIABLE",
  "KW_MEM_BUF_SIZE", "KW_QOUT_SIZE", "KW_DIR", "'('", "')'", "'{'", "'}'",
  "';'", "':'", "$accept", "start", "dest_diskq", "$@1",
  "dest_diskq_options", "dest_diskq_option", "string", "yesno", YY_NULLPTR
};
#endif
...
{
     -14,  -133,    13,  -134,  -134,  -134,  -130,  -131,  -129,  -128,
    -127,  -126,  -125,  -124,  -123,  -131,   -97,   -95,  -112,   -94,
     -93,  -115,  -134,  -134,  -119,  -118,  -134,  -134,  -134,  -117,
    -116,  -114,  -134,  -134,  -113,  -134,  -134,  -134,  -134,  -134,
    -134
};
...
static const yytype_uint8 yydefact[] =
{
       0,     0,     0,     3,     2,     1,     0,     6,     0,     0,
       0,     0,     0,     0,     0,     6,     0,     0,     0,     0,
       0,     0,     4,     5,     0,     0,    15,    16,    17,     0,
       0,     0,    13,    14,     0,     9,    10,     7,     8,    11,
      12
};
...
{
    -134,  -134,  -134,  -134,    15,  -134,  -134,  -134
};
...
{
      26,    27,    32,     1,     3,    33,    28,     8,     9,    10,
      11,    12,    13,     5,     7,    16,    17,    18,    19,    20,
      21,    24,    22,    25,    30,    31,    35,    36,    37,    38,
      23,    39,    40
};

static const yytype_uint8 yycheck[] =
{
     112,   113,   117,    17,   137,   120,   118,   138,   139,   140,
     141,   142,   143,     0,   144,   144,   144,   144,   144,   144,
     144,   118,   145,   118,   118,   118,   145,   145,   145,   145,
      15,   145,   145
};
...
{
       0,    17,   151,   137,   152,     0,   153,   144,   138,   139,
     140,   141,   142,   143,   154,   155,   144,   144,   144,   144,
     144,   144,   145,   154,   118,   118,   112,   113,   118,   157,
     118,   118,   117,   120,   156,   145,   145,   145,   145,   145,
     145
};
...
{
       0,   150,   151,   153,   152,   154,   154,   155,   155,   155,
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, LogDriverPlugin **instance, gpointer arg)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, CfgLexer *lexer, LogDriverPlugin **instance, gpointer arg)
{
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, CfgLexer *lexer, LogDriverPlugin **instance, gpointer arg)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, CfgLexer *lexer, LogDriverPlugin **instance, gpointer arg)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (lexer);
...
#line 298 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2491 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;

    case 120: /* LL_STRING  */
#line 298 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2497 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;

    case 122: /* LL_BLOCK  */
#line 298 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2503 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;

    case 156: /* string  */
#line 298 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2509 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;
...
int
yyparse (CfgLexer *lexer, LogDriverPlugin **instance, gpointer arg)
{
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 374 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2803 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 379 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    {
            last_plugin = diskq_dest_plugin_new();
            *instance = &last_plugin->super;
            last_options = &last_plugin->options;
          }
#line 2813 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 384 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_check_plugin_settings(last_options); }
#line 2819 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 393 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_reliable_set(last_options, (yyvsp[-1].num)); }
#line 2825 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 394 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_mem_buf_size_set(last_options, (yyvsp[-1].num)); }
#line 2831 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 395 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_mem_buf_length_set(last_options, (yyvsp[-1].num)); }
#line 2837 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 396 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_disk_buf_size_set(last_options, (yyvsp[-1].num)); }
#line 2843 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 397 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_qout_size_set(last_options, (yyvsp[-1].num)); }
#line 2849 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 398 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_set_dir(last_options, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2855 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 15:
#line 627 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 1; }
#line 2861 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 628 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 0; }
#line 2867 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 629 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 2873 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;


#line 2877 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 941 "modules/diskq/diskq-grammar.y" /* yacc.c:1906  */
