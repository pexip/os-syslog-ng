...
/* Line 264 of yacc.c  */
#line 416 "block-ref-grammar.c"
/* Unqualified %code blocks.  */

/* Line 265 of yacc.c  */
#line 47 "block-ref-grammar.y"
...
{
     138,     0,    -1,    -1,   139,   134,   140,   135,    -1,   141,
     140,    -1,    -1,   119,   134,   143,   135,    -1,   119,    -1,
     122,    -1,   142,    -1,   120,    -1,   121,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   293,   293,   293,   300,   301,   305,   310,   311,   326,
     327,   328
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_SCOPE", "'('", "')'", "':'", "$accept", "start", "$@1", "block_args",
  "block_arg", "string", "string_or_number", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10502, 10503, 10504, 10505,    40,    41,    58
};
# endif
...
{
       0,   137,   139,   138,   140,   140,   141,   142,   142,   143,
     143,   143
};
...
{
    -130,     4,  -129,  -130,  -113,  -127,  -126,  -113,  -119,  -130,
    -130,  -130,  -130,  -130,  -130,  -130,  -125,  -130
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
    -130,  -130,  -130,     1,  -130,  -130,  -130
};
...
{
     119,   120,   121,   122,     0,   134,   119,   134,     7,   135,
     135
};
...
{
       0,   138,   139,     0,   134,   119,   140,   141,   134,   135,
     140,   119,   120,   121,   122,   142,   143,   135
};
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, CfgLexer *lexer, CfgArgs **result, gpointer arg)
#else
static void
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (CfgLexer *lexer, CfgArgs **result, gpointer arg);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
