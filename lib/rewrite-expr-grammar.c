...
/* Line 264 of yacc.c  */
#line 416 "rewrite-expr-grammar.c"
...
/* Line 265 of yacc.c  */
#line 84 "rewrite-expr-grammar.y"
...
/* Line 265 of yacc.c  */
#line 501 "rewrite-expr-grammar.c"
...
{
     140,     0,    -1,   141,    -1,   142,    -1,   143,   135,   142,
      -1,   135,   142,    -1,    -1,    -1,   113,   136,   151,   151,
     144,   146,   137,    -1,    -1,   112,   136,   151,   145,   148,
     137,    -1,   119,    -1,   149,   146,    -1,   147,   146,    -1,
      -1,    29,   136,   151,   137,    -1,    78,   136,   152,   137,
      -1,   149,   148,    -1,    -1,   110,   136,   151,   137,    -1,
      -1,   134,   136,   150,   137,    -1,   119,    -1,   122,    -1,
     151,   152,    -1,    -1
};
...
{
       0,   332,   332,   336,   340,   341,   342,   347,   346,   358,
     357,   363,   382,   383,   384,   388,   394,   398,   399,   403,
     434,   433,   444,   445,   498,   499
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_SCOPE", "KW_CONDITION", "';'", "'('", "')'", "':'", "$accept",
  "start", "rewrite_expr_list", "rewrite_expr_list_build", "rewrite_expr",
  "$@1", "$@2", "rewrite_subst_opts", "rewrite_subst_opt",
  "rewrite_expr_opts", "rewrite_expr_opt", "$@3", "string",
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10502, 10503, 10504, 10505, 10507,    59,    40,    41,    58
};
# endif
...
{
       0,   139,   140,   141,   142,   142,   142,   144,   143,   145,
     143,   143,   146,   146,   146,   147,   147,   148,   148,   149,
     150,   149,   151,   151,   152,   152
};
...
{
    -105,  -130,  -121,  -131,  -105,    17,  -131,  -131,  -115,  -103,
    -103,  -131,  -131,  -105,  -131,  -131,  -131,  -103,  -131,  -107,
    -131,  -114,  -113,  -116,  -107,   -29,  -103,  -131,  -131,  -131,
    -112,  -111,  -109,   -29,   -29,  -106,  -104,  -103,  -103,  -131,
    -131,  -131,  -131,  -131,  -102,  -103,  -101,  -131,  -131,  -131
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
    -131,  -131,  -131,     0,  -131,  -131,  -131,   -22,  -131,     2,
     -14,  -131,    -8,   -13
};
...
{
      30,    16,    17,    21,    11,    24,     9,     1,     2,    20,
      24,    40,    41,    18,     3,    10,    14,    12,    35,    15,
      13,    28,    26,    27,    37,    38,    29,    22,    39,    44,
       4,    42,    48,    43,     0,    47,    49,     0,     0,     0,
...
{
      29,     9,    10,   110,     4,    19,   136,   112,   113,    17,
      24,    33,    34,    13,   119,   136,   119,     0,    26,   122,
     135,   137,   136,   136,   136,   136,    24,   134,   137,    37,
     135,   137,    45,   137,    -1,   137,   137,    -1,    -1,    -1,
...
{
       0,   112,   113,   119,   135,   140,   141,   142,   143,   136,
     136,   142,     0,   135,   119,   122,   151,   151,   142,   145,
     151,   110,   134,   148,   149,   144,   136,   136,   137,   148,
      29,    78,   146,   147,   149,   151,   150,   136,   136,   137,
     146,   146,   137,   137,   151,   151,   152,   137,   152,   137
};
...
/* Line 1455 of yacc.c  */
#line 332 "rewrite-expr-grammar.y"
...
/* Line 1455 of yacc.c  */
#line 336 "rewrite-expr-grammar.y"
...
/* Line 1455 of yacc.c  */
#line 340 "rewrite-expr-grammar.y"
...
/* Line 1455 of yacc.c  */
#line 341 "rewrite-expr-grammar.y"
...
/* Line 1455 of yacc.c  */
#line 342 "rewrite-expr-grammar.y"
    { (yyval.ptr) = NULL; }
    break;
...
/* Line 1455 of yacc.c  */
#line 347 "rewrite-expr-grammar.y"
    {
...
/* Line 1455 of yacc.c  */
#line 352 "rewrite-expr-grammar.y"
    {
...
/* Line 1455 of yacc.c  */
#line 358 "rewrite-expr-grammar.y"
    {
...
/* Line 1455 of yacc.c  */
#line 362 "rewrite-expr-grammar.y"
    { (yyval.ptr) = last_rewrite; }
    break;
...
/* Line 1455 of yacc.c  */
#line 364 "rewrite-expr-grammar.y"
    {
            Plugin *p;
            ...
            last_rewrite = (LogRewrite *) plugin_parse_config(p, configuration, &(yylsp[(1) - (1)]), NULL);
            free((yyvsp[(1) - (1)].cptr));
            if (!last_rewrite)
              {
                YYERROR;
...
/* Line 1455 of yacc.c  */
#line 389 "rewrite-expr-grammar.y"
    {
...
/* Line 1455 of yacc.c  */
#line 394 "rewrite-expr-grammar.y"
...
/* Line 1455 of yacc.c  */
#line 404 "rewrite-expr-grammar.y"
    {
...
/* Line 1455 of yacc.c  */
#line 434 "rewrite-expr-grammar.y"
    {
            FilterExprNode *filter_expr;

            CHECK_ERROR(cfg_parser_parse(&filter_expr_parser, lexer, (gpointer *) &filter_expr, NULL), (yylsp[(1) - (2)]), NULL);
...
/* Line 1455 of yacc.c  */
#line 498 "rewrite-expr-grammar.y"
...
/* Line 1455 of yacc.c  */
#line 499 "rewrite-expr-grammar.y"
    { (yyval.num) = 0; }
    break;
...
/* Line 1455 of yacc.c  */
#line 3031 "rewrite-expr-grammar.c"
      default: break;
    }
...
/* Line 1675 of yacc.c  */
#line 646 "rewrite-expr-grammar.y"
